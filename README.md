# Домашнее задание к занятию " `Teamcity` " - `Сулименков Алексей`
...
<details> <summary>В ответе пришлите ссылку на репозиторий.</summary>

https://github.com/biparasite/example-teamcity.git

</details>

<details> <summary>Немного скриншотов, если требуется</summary>
